...
import preview1 from "@assets/images/content/preview/preview-1.jpg";
import preview2 from "@assets/images/content/preview/preview-2.jpg";
import preview3 from "@assets/images/content/preview/preview-3.jpg";
import preview4 from "@assets/images/content/preview/preview-4.jpg";
import preview5 from "@assets/images/content/preview/preview_5.jpg";
import preview6 from "@assets/images/content/preview/preview-6.jpg";
import preview7 from "@assets/images/content/preview/preview-7.jpg";
import preview8 from "@assets/images/content/preview/preview-8.jpg";
import preview9 from "@assets/images/content/preview/preview-9.jpg";
import site_video1 from "@assets/images/content/sites/16k.mp4";
import montage1 from "@assets/images/content/montage/montage_1.mp4";
import montage2 from "@assets/images/content/montage/montage_2.mp4";
import montage3 from "@assets/images/content/montage/montage_3.mp4";
import montage4 from "@assets/images/content/montage/montage_4.mp4";
import design1 from "@assets/images/content/design/design_vostok.png";
import bank1 from "@assets/images/content/design/bank1.jpg";
import bank2 from "@assets/images/content/design/bank2.jpg";
import bank3 from "@assets/images/content/design/bank3.jpg";
import bank4 from "@assets/images/content/design/bank4.jpg";
import visit1 from "@assets/images/content/design/visit1.jpg";
import visit2 from "@assets/images/content/design/visit2.jpg";
import site1 from "@assets/images/content/design/site1.jpg";
import site2 from "@assets/images/content/design/site2.jpg";
import aud1 from "@assets/images/content/audio/audio_example1.mp4";
import aud2 from "@assets/images/content/audio/audio_example2.mov";
import sub1 from "@assets/images/content/subs/sub1.mp4";
import sub2 from "@assets/images/content/subs/sub2.mp4";
import sub3 from "@assets/images/content/subs/sub3.mp4";
...
const servicesBlock: IBlock[] = [
  {
    solutions: [
      ...
      },
      {
        ...
        iconPath: subtitles,
        description:
          "Улучшите свои короткие видео, добавив в них субтитры. Это поможет сделать содержание видео более доступным и понятным, улучшая взаимодействие с аудиторией и увеличивая его привлекательность. Идеально подходит для тех, кто стремится максимально расширить охват и увеличить вовлечённость зрителей.",
        price: [
          {
    ...
    solutions: [
      {
        ...
        description:
          "Если вы работаете с видео или аудио, то наверняка находитесь в поисках удобных сервисов для расшифровки речи в текст. Например, для субтитров или написания статей. Мы поможем с лёгкостью преобразовать ваш видео/аудио файл в текст. Вы сможете скачать результат в формате docx, txt и xlsx.",
        price: [
          {
            name: "",
            amount: [250, 10000],
      ...
      },
      {
        ...
        description:
          "Мы предлагаем профессиональный перевод вашего видео, аудио или статьи на английский язык. Эксперты с глубоким пониманием языка обеспечивают точность перевода и сохранение первоначального смысла материала. Расширьте свою аудиторию и увеличьте доступность вашего контента для англоязычных зрителей и читателей.",
        price: [
          {
            name: "",
            amount: 500,
    ...
    solutions: [
      {
        ...
        iconPath: site,
        description:
          "Мы создаём сайты и лендинги, которые не просто существуют, а работают на вас. Разрабатываем уникальные дизайны, которые отражают суть вашего бренда. Работаем над каждой деталью: от аккуратной вёрстки до полной адаптивности, чтобы ваш сайт выглядел отлично на любом устройстве. Если у вас уже есть сайт, но его нужно освежить или усовершенствовать, мы с радостью возьмёмся за доработку и внедрение нужных решений.",
        gallery: [
          {
            type: "video",
            src: site_video1,
    ...
    solutions: [
      {
        ...
        iconPath: auto,
        description:
          "Почему бы не сделать работу проще и быстрее? Наша команда разрабатывает клиент-серверные приложения и продвинутых ботов, способных выполнять разноплановые задачи. Будь то сложные бизнес-процессы или повседневные операции, мы создаём специализированные программы и сервисы, адаптированные под ваши нужды. Нужна собственная CRM? Без проблем! И, конечно, автоматическое ведение отчётности — чтобы вы тратили меньше времени на бумаги и больше на то, что действительно важно.",
      },
      {
        type: "buisness",
      ...
      },
      {
        ...
        iconPath: legal,
        description:
          "Хотите быть уверены в защите своих прав в сети и за её пределами? Мы предлагаем юридические услуги различной сложности как онлайн, так и офлайн. Поможем с любыми правовыми задачами — от подготовки документов, консультаций, защите в суде до решения сложных споров. Наши юристы, имеющие более 30 лет опыта, знают, как вас поддержать!",
      },
      {
        type: "buisness",
        title: "Интеграция ИИ",
    ...
    solutions: [
      {
        ...
        <div>
          ...
          <ul>
            ...
            <li>На базовом уровне начнёте разбираться в алгоритмах YouTube</li>
      ...
      },
      {
        ...
        <div>
          ...
          <ul>
           <li >Вы получите полностью настроённый и оптимизированный YouTube-канал, который сразу будет готов к работе</li><li >Впечатляющий и индивидуальный дизайн вашего канала, который понравится вашим зрителям</li><li >Ваш проект будет в надёжных руках опытного специалиста и дизайнеров</li><li >Благодаря правильному оформлению канала, вы удержите новых зрителей, повысите кликабельность канала и будете набирать новые просмотры</li>
          </ul>
        </div>
        <div>
          <strong>Сроки <i></i></strong>
      ...
      },
      {
        ...
        <div>
          <strong>Сроки <i></i></strong>
          <ul>
            <li >Срок подготовки одного видео - 3 дня</li><li >До 8 горизонтальных видео и 8 Shorts в месяц</li><li >В конце месяца приводим отчёт о проведённой работе, по необходимости созваниваемся в онлайн-формате</li>
          </ul>
        </div>
        `,
        price: [
  ...
  },
  {
    solutions: [
      ...
      <div>
        <strong>Преимущества <i></i></strong>
        <ul>
         <li >Автоматизация контента</li><li >Персональный план роста канала — наша команда поможет вывести ваш канал на новый уровень</li><li >Индивидуальная поддержка — решаем самые разнообразные вопросы, связанные с вашим YouTube-каналом</li><li >Ведение канала «под ключ» означает, что вам не придётся думать об алгоритмах, SEO, продвижении и поиске людей — мы всё сделаем за вас!</li><li >А также все преимущества Basic Pack</li>
        </ul>
      </div>
      <div>
        <strong>Сроки <i></i></strong>
        ...
        price: [
          {
            amount: 70000,
            isFrom: true,
            desc: "Цена зависит от вашей ниши, количества видео и Shorts в месяц, а также объёма монтажа",
          },
        ],
      },
      {
        ...
        price: [
          {
            amount: 100000,
            isFrom: true,
            desc: "Цена зависит от вашей ниши, объёма работ над конент-планом, количества видео и Shorts в месяц, объёма монтажа и дизайна",
          },
        ],
      },
    ],
    ...
    solutions: [
      {
        ...
        <div>
          <strong>Сроки <i></i></strong>
          <ul>
            <li >Срок SEO-подготовки Shorts - 2 часа</li><li >В конце месяца приводим отчёт о проведённой работе, по необходимости созваниваемся в онлайн-формате</li>
          </ul>
        </div>
        `,
        price: [
        ...
        price: [
          {
            amount: 60000,
            isFrom: true,
            desc: "Цена зависит от вашей ниши, объёма работ над контент-планом, количества Shorts в месяц, сложности монтажа",
          },
        ],
      },
    ],
